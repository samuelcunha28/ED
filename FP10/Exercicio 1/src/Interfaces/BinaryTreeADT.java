...
public interface BinaryTreeADT<T> {
     ...
     * is not found
     *
     * @param targetElement the element being sougth in the tree
     * @return a reference tio the specified element
     */
    ...
    /**
     * Performs a inorder traversal on this binary tree by calling an
